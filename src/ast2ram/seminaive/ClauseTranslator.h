...
protected:
    ...
    virtual Own<ram::Operation> addNegatedLeqAtom(Own<ram::Operation> op, const ast::Atom* atom) const;
    virtual Own<ram::Operation> addDistinct(Own<ram::Operation> op, const ast::Atom* atom1, const ast::Atom* atom2) const;
