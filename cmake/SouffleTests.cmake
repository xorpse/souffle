...
function(SOUFFLE_RUN_INTEGRATION_TEST)
    ...
    add_test(NAME ${PARAM_QUALIFIED_TEST_NAME}_run_souffle
      COMMAND ${RUBY_EXECUTABLE} ${PROJECT_SOURCE_DIR}/cmake/redirect.rb --out ${PARAM_TEST_NAME}.out
      --err ${PARAM_TEST_NAME}.err ${STDIN_ARGS}
      $<TARGET_FILE:souffle> ${PARAM_SOUFFLE_PARAMS} "${PARAM_INPUT_DIR}/${PARAM_TEST_NAME}.dl"
...
function(SOUFFLE_COMPARE_STD_OUTPUTS)
    ...
    add_test(NAME ${PARAM_QUALIFIED_TEST_NAME}_compare_std_outputs
      COMMAND ${RUBY_EXECUTABLE} "${PROJECT_SOURCE_DIR}/cmake/check_std_outputs.rb" "${PARAM_TEST_NAME}" "${PARAM_EXTRA_DATA}")
